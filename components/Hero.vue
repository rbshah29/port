<template>
    <div class="white pb-6 pt-4 m-2 text-center font-name">
        <div class="mt-2 m-4">
            ...
            <p class="text-left text-white font-bold text-5xl mb-2 font-name-1">Rutvik Shah</p>
        ...
        <div>
            <div class="text-center my-4">
                <div class="relative isolate flex flex-col justify-end overflow-hidden rounded-2xl px-8 pb-8 pt-40 max-w-sm mx-auto mt-24" style="height: auto;">
                    <img src="/assets/profile.jpg" class="absolute inset-0 h-full w-full object-cover" style="height: 280px;">
